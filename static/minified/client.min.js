let strLine="--------------------------------------------";let hooty_server_url='http://localhost:3000';let defaultPlayer='hooty__';let version='0.026'
...
document.getElementById('btnShowDamage').addEventListener('click',(event)=>{if(vuePlayerReport.isHidden){document.getElementById('btnShowDamage').textContent='Hide damage/health'}else{document.getElementById('btnShowDamage').textContent='Show damage/health'}
...
function ShowModal(){console.log('show modal()');document.getElementById('div-modal').style.display='block';document.getElementById('div-modal').scrollIntoView({behavior:"smooth"})}
function HideModal(){console.log('hide modal()');document.getElementById('div-modal').style.display='none';vuePlayerReport.clearPlayerReport()}
...
vuePlayerReport.updatePlayerReport(selectedPlayer,tmpKiller,playerTeam,killerTeam,axios_telemetry_response.data.arrPlayerCards,axios_telemetry_response.data.arrPlayersDamageLog,axios_telemetry_response.data.allBotNames,axios_telemetry_response.data.allHumanNames);ShowModal()}
